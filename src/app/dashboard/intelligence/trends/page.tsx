  ...
  return (
    <div className="space-y-7 pb-14">
      ...
      <form className="grid gap-3 border border-border bg-card p-4 md:grid-cols-6">
        ...
        <label className="text-xs font-medium">Quality<select name="status" defaultValue={params.status ?? "qualified"} className="mt-1 h-10 w-full border border-border bg-background px-3 text-sm"><option value="qualified">Qualified only</option><option value="all">All signals</option><option value="insufficient_support">Insufficient support</option><option value="source_concentrated">Source concentrated</option><option value="incomplete_coverage">Incomplete coverage</option></select></label>
      ...
      <form className="space-y-3">
        <input type="hidden" name="window" value={data.windowType} /><input type="hidden" name="channel" value={data.channel} /><input type="hidden" name="domain" value={params.domain ?? "all"} /><input type="hidden" name="status" value={params.status ?? "qualified"} /><input type="hidden" name="q" value={params.q ?? ""} />
