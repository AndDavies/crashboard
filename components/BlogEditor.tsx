...
const BlogEditor: React.FC<BlogEditorProps> = ({ initialData, onSaveComplete }) => {
  ...
  const handleImageUpload = async (event: React.ChangeEvent<HTMLInputElement>): Promise<void> => {
    ...
    const { error } = await supabaseBlog.storage.from("images").upload(fileName, file);
    if (error) {
  ...
  return (
    <div className="w-full mx-auto p-8 font-sans grid grid-cols-1 lg:grid-cols-4 gap-8">
      <div className="lg:col-span-3 space-y-8">
        ...
        <section className="space-y-4">
          ...
          <div className="border border-muted rounded-md p-4 relative">
            ...
            <div className="min-h-[400px] prose prose-lg pt-16">
      ...
      <div className="lg:col-span-1 space-y-4">
        ...
        <div className="bg-gray-100 p-4 rounded-md">
          <h4 className="text-lg font-medium mb-2">Image Dimensions</h4>
          <UITable>
            <UITableHeader>
              <UITableRow>
                <UITableHead>Image Type</UITableHead>
                <UITableHead>Dimensions</UITableHead>
                <UITableHead>Aspect</UITableHead>
                <UITableHead>Max Size</UITableHead>
              </UITableRow>
            </UITableHeader>
            <UITableBody>
              <UITableRow>
                <UITableCell>Featured Header</UITableCell>
                <UITableCell>1600×900</UITableCell>
                <UITableCell>16:9</UITableCell>
                <UITableCell>200KB</UITableCell>
              </UITableRow>
              <UITableRow>
                <UITableCell>Blog Card Thumbnail</UITableCell>
                <UITableCell>800×450</UITableCell>
                <UITableCell>16:9</UITableCell>
                <UITableCell>70KB</UITableCell>
              </UITableRow>
              <UITableRow>
                <UITableCell>In-Content Images</UITableCell>
                <UITableCell>1200×675</UITableCell>
                <UITableCell>16:9</UITableCell>
                <UITableCell>150KB</UITableCell>
              </UITableRow>
              <UITableRow>
                <UITableCell>Square Images</UITableCell>
                <UITableCell>1200×1200</UITableCell>
                <UITableCell>1:1</UITableCell>
                <UITableCell>150KB</UITableCell>
              </UITableRow>
            </UITableBody>
          </UITable>
